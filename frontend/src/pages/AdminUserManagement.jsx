...
export default function AdminUserManagement() {
    ...
    const totalManagers = users.filter(
        (item) => item.role === "INVENTORY_MANAGER"
    ).length;
    ...
    const availableBranchesForForm = useMemo(() => {
        if (formData.role !== "INVENTORY_MANAGER") {
            return branches;
        }
        ...
        return branches.filter((branch) => {
            ...
            // When editing existing manager, keep their current branch visible
            if (
            ...
            <div className="grid h-full grid-cols-[250px_minmax(0,1fr)]">
                <aside className="flex min-h-0 flex-col bg-[#d9edf8] px-5 py-6 border-r border-blue-100">
                    ...
                    <nav className="min-h-0 flex-1 space-y-3 overflow-y-auto overflow-x-hidden pr-1">
                        ...
                        <SidebarButton active icon={Users} label="User Management" />
                    ...
                    <header className="mb-8 flex items-center gap-5">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-[#6f85a3]">
                                Register, update, activate, deactivate, and manage system users.
                            </p>
    ...
    return (
        <div>
            ...
            <input
                ...
                className={`w-full rounded-2xl px-4 py-3 font-semibold text-[#17325c] outline-none placeholder:text-[#8aa0bb] ${error
